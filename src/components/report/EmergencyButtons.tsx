    ...
    <div className="grid grid-cols-1 gap-6 w-full max-w-md mx-auto">
      ...
      >
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <span className="text-2xl font-bold">Report Accident</span>
          <span className="text-sm opacity-80 font-normal">Vehicle collision, road incident</span>
        </div>
      </Button>
      ...
      >
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <span className="text-2xl font-bold">Medical Emergency</span>
          <span className="text-sm opacity-80 font-normal">Injuries, need ambulance</span>
        </div>
      </Button>
    </div>
  );
